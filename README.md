...
Одноразовые probe’ы удаляются автоматически, как только выполнят свою задачу, 
...
времени жизни объектов и влияния на задержки. Probe-метод для разрешения, возможно, не самый лёгкий, 
но он был выбран осознанно как быстрый способ гарантированно получить размеры кадра 
без риска "гонок данных" и без разбора H.264 SPS вручную.
